...
import { rentData } from "@/data/topCards/rentData";
import { propertiesData } from "@/data/topCards/propertiesData";
import { unitsData } from "@/data/topCards/unitsData";
import { tenantsData } from "@/data/topCards/tenantsData";
...
export default function TopCards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="grid grid-cols-3 bg-white shadow-sm rounded-lg px-4 py-2">
