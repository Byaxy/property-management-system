...
export let PROPERTY_TYPES: string[] = Object.values(PropertyType);
export let DEFAULT_MODEL_OPTIONS: SchemaOptions = { timestamps: true, bufferCommands: process.env.NODE_ENV !== "production", autoCreate: false };
