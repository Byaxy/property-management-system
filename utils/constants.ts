let IDENTIFICATION_TYPE: string[] = ["NATIONAL ID", "PASSPORT"];
let GENDER: string[] = ["MALE", "FEMALE", "N/A"];
let EMPLOYMENT_STATUS: string[] = ["EMPLOYED", "SELF-EMPLOYED", "UNEMPLOYED"];
let MARITAL_STATUS: string[] = ["MARRIED", "SINGLE", "DIVORCED", "WIDOWED", "SEPARATED"];
...
let ROLES: string[] = ["ADMIN", "MANAGER", "TENANT"];
